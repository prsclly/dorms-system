@php
    $menuJson = file_get_contents(resource_path('menu/verticalMenuResident.json'));
...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo">
    <a href="{{ route('resident.dashboard') }}" class="app-brand-link">
      <span class="app-brand-logo demo">@include('_partials.macros', ["width" => 25])</span>
      <span class="app-brand-text demo menu-text fw-bold ms-2">Resident</span>
    </a>
