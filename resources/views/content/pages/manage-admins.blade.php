...
<button class="dropdown-item text-danger" data-bs-toggle="modal" data-bs-target="#deleteAdminModal{{ $admin->id }}">
...
<div class="modal fade" id="editAdminModal{{ $admin->id }}" tabindex="-1">
  <div class="modal-dialog">
    <form method="POST" action="{{ route('admin.manage.admins.update', $admin->id) }}" class="modal-content text-start">
      @csrf @method('PUT')
